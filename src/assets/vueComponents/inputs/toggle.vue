<template>
    <div class="w-[10vw] flex justify-center">
        <div @click="toggle" role="switch" :aria-checked="isActive"
            ...
            <!-- Toggle slider -->
            <div class="absolute z-10 h-12 w-12 bg-white rounded-xl flex items-center justify-center shadow transition-transform duration-300 ease-in-out will-change-transform border-4"
                :class="isActive
