...
<template>
  <div class="w-screen h-screen flex flex-row items-center justify-between gap-4.5">
    <ovSidebar/>
    <div v-if="sidebarStore.isOpen" class="fixed opacity-50 w-screen h-screen bg-black"></div>
