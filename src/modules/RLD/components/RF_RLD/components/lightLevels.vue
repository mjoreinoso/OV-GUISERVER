...
const { RF, Average, LastRjtdRFArray } = storeToRefs(rfStore);

</script>

<template>
  <div class="grid grid-cols-[0.5fr_1fr_1fr_1fr] gap-x-2 grow text-white text-[1.1vw] p-3 border-2 rounded-xl">
    <!-- Encabezado -->
    <div></div>
