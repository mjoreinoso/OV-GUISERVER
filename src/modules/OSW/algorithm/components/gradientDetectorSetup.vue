<template>
    <div class="flex flex-col p-2.5  rounded-xl border-2 justify-between grow">
...
import { gradientSourceOptions, gradientTypeOptions } from '../store/algorithmSelectOptions';
